    ...
    <div className="mx-auto max-w-7xl px-4 py-8 sm:py-12 sm:px-6 lg:px-8">
      <div className="mb-12 sm:mb-16">
        ...
        <p className="mt-4 sm:mt-6 text-base sm:text-lg lg:text-xl leading-relaxed text-primary-700 max-w-3xl font-medium">
          The telecom industry faces unprecedented complexity: 5G rollouts, edge computing, multi-cloud operations, and rising customer expectations. Agentic AI isn't just automation—it's intelligent orchestration that transforms how telecoms operate, compete, and create value.
        </p>
      </div>
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm text-primary-700">
              <li className="flex items-start">
                ...
                <span><strong>40-60%</strong> reduction in process cycle times across customer operations, service delivery, and network management</span>
              </li>
              <li className="flex items-start">
                <span className="mr-2 mt-1.5 h-1.5 w-1.5 flex-shrink-0 rounded-full bg-accent" />
                <span><strong>25-35%</strong> cost reduction through intelligent automation and resource optimization</span>
              </li>
              <li className="flex items-start">
                <span className="mr-2 mt-1.5 h-1.5 w-1.5 flex-shrink-0 rounded-full bg-accent" />
                <span><strong>3-5x</strong> productivity gains as workforce shifts from routine tasks to strategic work</span>
              </li>
              <li className="flex items-start">
                <span className="mr-2 mt-1.5 h-1.5 w-1.5 flex-shrink-0 rounded-full bg-accent" />
                <span><strong>15-25%</strong> improvement in customer satisfaction through faster, more accurate service delivery</span>
              </li>
            </ul>
          </div>
          <div>
            ...
            <ul className="space-y-3 text-sm text-primary-700">
              <li className="flex items-start">
                <span className="mr-2 mt-1.5 h-1.5 w-1.5 flex-shrink-0 rounded-full bg-accent" />
                <span><strong>Zero-touch operations:</strong> Autonomous service provisioning, network optimization, and customer support</span>
              </li>
              <li className="flex items-start">
                <span className="mr-2 mt-1.5 h-1.5 w-1.5 flex-shrink-0 rounded-full bg-accent" />
                <span><strong>Predictive intelligence:</strong> Proactive issue detection, capacity planning, and churn prevention</span>
              </li>
              <li className="flex items-start">
                <span className="mr-2 mt-1.5 h-1.5 w-1.5 flex-shrink-0 rounded-full bg-accent" />
                <span><strong>Intelligent orchestration:</strong> Multi-system coordination for complex workflows like order-to-activation</span>
              </li>
              <li className="flex items-start">
                <span className="mr-2 mt-1.5 h-1.5 w-1.5 flex-shrink-0 rounded-full bg-accent" />
                <span><strong>Human-AI collaboration:</strong> Strategic decision-making with AI handling routine operations</span>
              </li>
            </ul>
          </div>
        </div>
      ...
      <ProcessMap processes={processes} industry="telecom" />
    </div>
  );
}
